...
func wireApp(confServer *conf.Server, confData *conf.Data, jwt *conf.JWT, payment *conf.Payment, ai *conf.AI, logger log.Logger) (*kratos.App, func(), error) {
	...
	paymentUsecase := biz.NewPaymentUsecase(paymentRepo, wxPayGateway, alipayGateway, logger)
	...
	httpServer := server.NewHTTPServer(confServer, jwt, greeterService, userService, paymentService, walletService, notifyService, supportService, logger)
